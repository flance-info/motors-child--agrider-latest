...
$regular_price      = get_post_meta($listing_id, 'price', true);
            ...
            <div class="single-car-prices">
                <div class="single-regular-price text-center">
                    ...
                    <?php else : ?>
                        ...
                        <?php endif; ?>
                        <span class="h3">
                            <?php esc_html_e('Price', 'motors-child'); ?>: <?php echo wp_kses_post(apply_filters('stm_filter_price_view', '', $price)); ?>
                        </span>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <?php if ($regular_price) : ?>
                        <p class="stm-regular-price"><span><?php esc_html_e('Price', 'motors-child'); ?>:</span>
                            <?php if (!empty($sale_price)) : ?>
                                <span class="stm-line-through"><?php echo esc_html(apply_filters('stm_filter_price_view', '', $regular_price)); ?></span>
                            <?php else : ?>
                                <?php echo esc_html(apply_filters('stm_filter_price_view', '', $regular_price)); ?>
                            <?php endif; ?>
                        </p>
                    <?php endif; ?>
                    <?php if ($sale_price) : ?>
