<?php
add_action( 'butterbean_register', 'stm_listings_register_manager_ss', 10, 2 );
function stm_listings_register_manager_ss( $butterbean, $post_type ) {
    ...
    $butterbean->unregister_manager('stm_car_manager');
    ...
    if ( 'car_dealer_elementor' === stm_get_current_layout() || 'car_dealer_two_elementor' === stm_get_current_layout() || 'car_dealer_elementor_rtl' === stm_get_current_layout() ) {
        $manager->register_section(
            'motors_listing_info',
            array(
    ...
    $manager->register_control(
        ...
        array(
            'type'    => 'number',
            'section' => 'stm_price',
            'label'   => esc_html__( 'Leasing price', 'stm_vehicles_listing' ),
            'attr'    => array(
                'class' => 'widefat',
            ),
        )
    ...
    if ( apply_filters( 'stm_is_equipment', false ) ) {
        ...
        $manager->register_control(
            ...
            array(
                ...
                'section' => 'stm_price',
                'preview' => '',
                'label'   => esc_html__( 'Genuine Rent Price', 'stm_vehicles_listing' ),
                'attr'    => array(
                    'class' => 'widefat',
                ),
            )
    ...
    if ( true === apply_filters( 'stm_is_dealer_two', false ) ) {
        if ( apply_filters( 'stm_me_get_nuxy_mod', false, 'enable_woo_online' ) ) {
            $manager->register_control(
                'car_mark_woo_online',
                array(
                    'type'        => 'checkbox',
    ...
    if ( function_exists( 'stm_sold_status_enabled' ) && apply_filters( 'stm_sold_status_enabled', true ) ) {
        $manager->register_control(
            'car_mark_as_sold',
            array(
                'type'        => 'checkbox',
    ...
    if ( false === apply_filters( 'stm_is_aircrafts', false ) ) {
        $manager->register_control(
            'vin_number',
            array(
                'type'    => 'text',
    ...
    // electir vehicle charging times
    if ( true === apply_filters( 'stm_is_ev_dealer', false ) ) {
        $manager->register_control(
            ...
            array(
                'type'    => 'text',
                'section' => 'stm_options',
                'label'   => esc_html__( 'Home charge time', 'stm_vehicles_listing' ),
                'attr'    => array( 'class' => 'widefat' ),
            )
        );
        ...
        $manager->register_control(
            ...
            array(
                'type'    => 'text',
                'section' => 'stm_options',
                'label'   => esc_html__( 'Fast charge time', 'stm_vehicles_listing' ),
                'attr'    => array( 'class' => 'widefat' ),
            )
        );
    }
    ...
    if ( 'car_dealer_elementor' === stm_get_current_layout() || 'car_dealer_two_elementor' === stm_get_current_layout() || 'car_dealer_elementor_rtl' === stm_get_current_layout() ) {
        $manager->register_control(
            ...
            array(
                ...
                'label'       => esc_html__( 'Specifications', 'stm_vehicles_listing' ),
                'description' => __( 'Learn more about the Listing Manager Specification <a href="" target="_blank">here</a>', 'stm_vehicles_listing' ),
    ...
    if ( false === apply_filters( 'stm_is_equipment', false ) ) {
